	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
		...
		<div class="wrapper row-offcanvas row-offcanvas-left">
			...
			<c:if test="${webratio:isTargetAccessible('page45.link', pageContext)}">
									<li class="active"><a href="<webratio:Link escapeXml="true" link="page45.link"/>">Contacto</a></li>
			</c:if>
                ...
                <section class="content-header clearfix">
                    ...
                    <ol class="breadcrumb">
                    	<li>
						 ...
						 <li><c:if test="${webratio:isTargetAccessible('page45.link', pageContext)}">	
 <a class="" href="<webratio:Link link="page45.link"/>">
   Contacto
</a>
			</c:if>
 </li>
...
<c:if test="${not(empty mssu30) and (mssu30.dataSize gt 0)}">
	<div class="alert alert-info ">
		<span class="glyphicon glyphicon-info-sign"></span>
		<c:forEach var="current" varStatus="status" items="${mssu30.data}">
