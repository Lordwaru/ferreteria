...
<c:if test="${webratio:getStartOperation(pageContext) ne 'lou5'}">
            ...
            <aside class="right-side">
                <section class="content-header clearfix">
						<h1>Alta Producto OK</h1>
                    <ol class="breadcrumb">
                    	<li>
                    		<a href="page25.do">
                    		<span class="glyphicon glyphicon-home"></span> Home</a>
                    	</li>
						<li class="active">Alta Producto OK</li>
                    </ol>
                </section>
...
<c:if test="${not(empty mssu37) and (mssu37.dataSize gt 0)}">
	<div class="alert alert-info ">
		<span class="glyphicon glyphicon-info-sign"></span>
		<c:forEach var="current" varStatus="status" items="${mssu37.data}">
