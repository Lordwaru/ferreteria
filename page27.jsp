                ...
                <section class="content-header clearfix">
                    ...
                    <ol class="breadcrumb">
                    	<li>
						 ...
						 <li><c:if test="${webratio:isTargetAccessible('page27.link', pageContext)}">	
 <a class="" href="<webratio:Link link="page27.link"/>">
   Quienes Somos
</a>
			</c:if>
 </li>
...
<c:if test="${not(empty mssu18) and (mssu18.dataSize gt 0)}">
	<div class="alert alert-info ">
		<span class="glyphicon glyphicon-info-sign"></span>
		<c:forEach var="current" varStatus="status" items="${mssu18.data}">
