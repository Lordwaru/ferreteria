                ...
                <section class="content-header clearfix">
                    ...
                    <ol class="breadcrumb">
                    	<li>
						 ...
						 <li><c:if test="${webratio:isTargetAccessible('page28.link', pageContext)}">	
 <a class="" href="<webratio:Link link="page28.link"/>">
   Catalogo/Servicios
</a>
			</c:if>
 </li>
...
<c:if test="${not(empty mssu19) and (mssu19.dataSize gt 0)}">
	<div class="alert alert-info ">
		<span class="glyphicon glyphicon-info-sign"></span>
		<c:forEach var="current" varStatus="status" items="${mssu19.data}">
	...
	<div class="box-body">
		<div class="plain ">
			<div class="plain IndexUnit">
				...
				<table class="table table-bordered table-hover table-striped" id="inu2_0_sortable">
					<thead>
						<tr>
				...
				<c:forEach var="current" varStatus="status" items="${inu2.data}">
					<c:set var="index" value="${status.index}"/>	
						<tr<c:if test="${inu2.currentIndex eq index}"> class="info"</c:if>>	
								<td class=" string">
